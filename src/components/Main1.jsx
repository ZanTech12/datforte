      ...
      <div className="container  pb-5 w-full grid grid-cols-1 lg:grid-cols-1 mt-5 relative">
        ...
        <div  className='bg-cover bg-center lg:p-[3rem]  container lg:w-[1000px]'>
          <div className='flex items-center gap-3 justify-start '>
            <img src="https://getwpteam.com/wp-content/uploads/2022/02/16" className='shadow rounded-full w-[80px] lg:w-[90px] h-[80px] lg:h-[90px] object-cover' alt="Picture required" />
            <div className='flex flex-col'>
              <span className='lg:text-2xl text-xl font-bold'>Mr Akin Ijiwole</span>
